...
import note from '../../image/pencil.png';
        ...
        <AppBar className={classes.appBar} position='sticky' color='inherit'>
            <Grid container justify='flex-start' alignItems='center' spacing={3}>
                <Grid item container justify='flex-start' xs={12} md={1}>
                    <img className={classes.icon} src={note} alt="icon" height="100" />
                </Grid>
            </Grid>
            <Grid item xs={12} md={10} container justify='center' alignItems='center' >

                <Typography className={classes.heading} component={Link} to='/' variant='h4' align='center'>YOUR NOTE</Typography>
            </Grid>
